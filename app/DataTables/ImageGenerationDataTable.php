    ...
    public function dataTable($query)
    {
        return datatables()->eloquent($query)
            ...
            ->addColumn('action', function ($generationImage) {
                ...
                $downloadBtn = '<a href="'.route("backend.pages.generations.download", $generationImage->id).'" class="btn btn-primary" style="font-size: 10px;width: 100%; margin-bottom: 3px;">Download</a>';

                // $editAction = '<a href="' . route("backend.pages.sticker.edit", $generationImage->id) . '" class="item-edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit font-small-4"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></a>';

                // $deleteAction = '<a form-alert-message="Kindly Confirm the removal of this Sticker" ' .
                //     'form-id="chargeDelete' . $generationImage->id . '" class="deleteModel" href="'
                //     . route('backend.pages.sticker.destroy', $generationImage->id) . '" data-toggle="tooltip" ' .
                ...
                // $deleteAction .= Form::open(['action' => ['App\Http\Controllers\Backend\StickerController@destroy', $generationImage->id],
                //     'method' => 'DELETE', 'id' => 'chargeDelete' . $generationImage->id . '']);
