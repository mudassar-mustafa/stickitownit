    ...
    public function dataTable($query)
    {
        return datatables()->eloquent($query)
            ...
            ->addColumn('name', function ($feature) {
                return empty($feature->name) ? "None" : $feature->name;
            })
            ...
            ->addColumn('status', function ($feature) {
                return ($feature->status == "active") ? '<span class="badge rounded-pill btn btn-success">Active</span>' : '<span class="badge rounded-pill btn btn-danger">De-active</span>';
            })
            ->escapeColumns(
                []
            )
            ->addColumn('action', function ($feature) {
                ...
                $deleteAction .= Form::open(['action' => ['App\Http\Controllers\Backend\FeaturesController@destroy', $feature->id],
                    'method' => 'DELETE', 'id' => 'chargeDelete' . $feature->id . '']);
