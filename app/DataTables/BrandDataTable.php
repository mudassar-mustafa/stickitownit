    ...
    public function dataTable($query)
    {
        ...
        ->filterColumn('name', function($query, $keyword) {
            ...
            ->addColumn('status',function ($brand){
                return ($brand->status == "active") ?  '<span class="badge rounded-pill badge-light-success">Active</span>' : '<span class="badge rounded-pill badge-light-danger">Deactive</span>';
            })
            ->escapeColumns(
                []
            )
