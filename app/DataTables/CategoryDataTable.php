        ...
        return datatables()->eloquent($query)
            ...
            ->addColumn('action', function ($category) {
                ...
                $deleteAction = '<a form-alert-message="Kindly Confirm the removal of this category" ' .
                    ...
                    . route('backend.pages.categories.destroy', $category->id) . '" data-toggle="tooltip" ' .
                ...
                $deleteAction .= Form::open(['action' => ['App\Http\Controllers\Backend\CategoryController@destroy', $category->id],
