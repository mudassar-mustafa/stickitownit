                            ...
                            <div class="slider__flex">
                                ...
                                <div class="slider__images">
                                    <div class="swiper-container">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="slider__image"><img src="https://picsum.photos/1920/1080"
                                                        alt="" /></div>
                                            </div>
                                            <div class="swiper-slide">
        ...
        <div class="row mb-30">
            ...
            <div class="col-md-2">
                <div
                    ...
                    <div class="cp-slider-round-button cp-product-button-prev"><i class="fas fa-chevron-left"></i></div>
                    <div class="cp-slider-round-button cp-product-button-next"><i class="fas fa-chevron-right"></i>
                    </div>
                </div>
            </div>
        </div>
