        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Update {{ $state->name }} State</h5>
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{route('backend.pages.state.update',$state->id)}}"
                                  method="POST">
                                @csrf
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <select id="status" class="form-select" name="status">
                                        <option value="active" {{ $state->status === 'active' ? 'selected' : '' }}>
                                            Active
                                        </option>
                                        <option value="inactive" {{ $state->status === 'inactive' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
