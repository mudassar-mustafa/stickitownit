        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Update {{ $blog->name }} Blog</h5>
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{route('backend.pages.blogs.update',$blog->id)}}"
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <select id="status" class="form-select" name="status">
                                        ...
                                        <option
                                            value="inactive" {{ $blog->status === 'inactive' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="example">
                                                ...
                                                <div id="dropzoneForm" class="dropzone dz-clickable">
                                                    @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="example">
                                                <div class="card-body">
                                                    ...
                                                    <div class="gallery" id="uploaded_image">
                                                        <div class="row">
                                                            <ul class="nav nav-pills source-code">
                                                                @foreach ($blog->blogImages->chunk(5) as $imageData)
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <input id="meta_title" type="text"
                                           ...
                                           name="meta_title"
                                           value="{{ old('meta_title',$blog->meta_title) }}" autocomplete="meta_title">
                                ...
                                <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <textarea id="meta_description"
                                              ...
                                              autocomplete="meta_description">{{ old('meta_description',$blog->meta_description) }}</textarea>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function load_images() {
            $.ajax({
                url: "{{ route('backend.pages.blogs.media.fetch',$blog->id) }}",
