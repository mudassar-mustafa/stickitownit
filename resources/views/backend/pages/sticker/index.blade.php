                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title"> Stickers</h4>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{route('backend.pages.sticker.create')}}" class="float-end">
                                        <button type="button" class="btn btn-primary me-1 pull-right">Add New sticker
                                        </button>
                                    </a>
                                </div>
                            </div>
